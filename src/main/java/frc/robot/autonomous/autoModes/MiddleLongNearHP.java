...
public class MiddleLongNearHP extends SequentialCommandGroup {
    public MiddleLongNearHP(RobotContainer robotContainer) {
        PathPlannerTrajectory blueTrajectory = PathPlanner.loadPath("MiddleLongNearHPBlue", 1.75, 1.0);
        PathPlannerTrajectory redPath = PathPlanner.loadPath("MiddleLongNearHP", 1.75, 1.0);
