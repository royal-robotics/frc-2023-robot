...
public class HighMiddleLongCubeNearHP extends SequentialCommandGroup {
    public HighMiddleLongCubeNearHP(RobotContainer robotContainer) {
        PathPlannerTrajectory blueTrajectory = PathPlanner.loadPath("HighMiddleLongCubeNearHP", 1.75, 1);
        ...
        this.addCommands(
            ...
            new ParallelDeadlineGroup(
                new SequentialCommandGroup(
                    ...
                    new AutoExtendIntake(robotContainer.s_Arm, robotContainer.s_Intake, Constants.Drivebase.chargeStationWheelSpeed, 4.0),
