...
public class MiddleLongFarHP extends SequentialCommandGroup {
    public MiddleLongFarHP(RobotContainer robotContainer) {
        PathPlannerTrajectory blueTrajectory = PathPlanner.loadPath("MiddleLongFarHPBlue", 1.75, 1.0);
        PathPlannerTrajectory redPath = PathPlanner.loadPath("MiddleLongFarHP", 1.75, 1.0);
